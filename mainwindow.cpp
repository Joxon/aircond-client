...
double  outside_temperature = 28; //室外温度恒定
   ...
   ui(new Ui::MainWindow)
{
   ...
   ui->state_label->setText("power off");
...
//      tcpSocket->bind(9999);
      tcpSocket->connectToHost("10.206.12.202", 6666);
      //192.168.137.1
      ...
      {
         ui->state_label->setText("waiting for serve");
      }
   }
   else
   {
